...
const level = (game) => __awaiter(void 0, void 0, void 0, function* () {
    yield levelIntro(game.numBadgers);
    ...
    const endLevel = new Promise(resolve => {
        const levelInterval = setInterval(() => __awaiter(void 0, void 0, void 0, function* () {
            const isEndLevel = checkLevelEnd(user, badgers);
            if (isEndLevel) {
                clearInterval(levelInterval);
                process.stdin.removeListener('keypress', onKeyPress);
                yield levelEnd(user, badgers, game, leveller);
                resolve();
            }
            game.incTurn();
